...
// Estratégia: cache-first para estáticos (HTML/CSS/JS/ícones/fontes),
...
// Ajuste esta lista para os arquivos reais do seu projeto.
...
self.addEventListener('fetch', (event) => {
  ...
  // Navegação (abrir páginas): network-first, cai pro cache/offline se falhar.
  ...
  // Estáticos (CSS/JS/ícones/fontes): cache-first, atualiza em segundo plano.
  event.respondWith(
